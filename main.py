...
<body>
    ...
    <script>
        ...
        // Функция форматирования баланса (например: 2468.943... -> 2.468,94)
        ...
        window.onload = function() {
            ...
            // Инициализация стартового баланса при загрузке страницы
        ...
        function startMinesGame() {
            ...
            // Получаем реальное числовое значение из текста баланса (убираем точки разделители и меняем запятую на точку)

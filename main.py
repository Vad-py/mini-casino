...
<body>
    ...
    <script>
        ...
        function startFlight() {
            ...
            fetch('/spin', { method: 'POST' }).catch(()=>{}); // синхронизация бэкенда при списании ставки (условно)
            // Но лучше сделаем локальный вычет для плавности интерфейса ракеты:

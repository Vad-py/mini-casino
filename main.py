...
<head>
    ...
    <style>
        ...
        /* Правила для рулетки (в левом синем квадрате) */
        .roulette-rules {
            position: absolute;
            top: 220px;
            left: 50px;
...
<body>
    ...
    <div class="container">
        ...
        <div id="roulette-screen" class="game-screen">
            ...
            <!-- Правила рулетки в левом блоке -->
            <div class="roulette-rules">
                <h4>Правила игры:</h4>
                1. Выберите сумму ставки (100, 250, 500).<br>
                2. Выберите режим:<br>
                &nbsp;&nbsp;• <b>На цвет</b> (красный / черный): выигрыш <b>x2.0</b> от ставки.<br>
                &nbsp;&nbsp;• <b>На число</b> (от 1 до 30): выигрыш <b>x30</b> при угадывании!
            </div>
            ...
            <div class="roulette-wrapper">
                ...
                <div class="controls-panel">
                    ...
                    <select id="r-type" onchange="changeBetType()">
                        <option value="color">На цвет (х2.0)</option>
...
def spin_roulette():
  ...
  if bet_type == "color":
    if bet_value == winning_color:
      win = int(bet_amount * 2.0)  # Честный коэффициент х2.0

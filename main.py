...
# Фиксированный порядок чисел на колесе (перемешанные цвета и номера)
WHEEL_LAYOUT = [
    {"number": 4, "color": "red"},
            ...
            <div class="roulette-wrapper">
                ...
                <div class="controls-panel">
                    ...
                    <div id="number-choice-div" style="display: none;">
                        ...
                        <input type="number" id="r-number" min="1" max="30" value="4">
                    </div>
...
def spin_roulette():
  ...
  # Выбираем случайный сектор из нашего фиксированного рандомного колеса
  ...
  message = (
      f"Выпало число {winning_number} ({color_name}). "
  )

...
<body>
    ...
    <script>
        ...
        // 3. Общий звук выигрыша (для слотов и колеса)
        ...
        // 4. Общий звук проигрыша (для слотов и колеса)
        ...
        // 5. Звук успеха в Минах (успешно открытая ячейка с биткоином)
        ...
        function spinSlots() {
            ...
            let animInterval = setInterval(() => {
                ...
                playSlotSpinSound(); // Звук прокрута слотов
                counter++;
                if (counter > 15) {
        ...
        function spinRoulette() {
            ...
            .then(data => {
                ...
                let tickTimes = [0, 400, 900, 1500, 2200, 3000, 3700, 4200, 4600, 4900];
                tickTimes.forEach(t => {
                    setTimeout(() => playTickSound(), t);
                });
        ...
        function clickMinesCell(index) {
            ...
            .then(data => {
                ...
                if (data.hit_mine) {
                    ...
                    cell.innerText = '💣';
                    playMinesBombSound(); // Звук взрыва бомбы
                    endMinesGame(false, data.mines_list);
                } else {
                    cell.classList.add('gem');
                    cell.innerText = '₿';
                    playMinesSuccessSound(); // Звук успешного шага

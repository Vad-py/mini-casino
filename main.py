...
<head>
    ...
    <style>
        ...
        /* Правила для рулетки (аккуратно слева в ряд) */
        .roulette-rules {
            position: absolute;
            top: 75px;
            left: 20px;
        ...
        .roulette-rules h4 { margin: 0 0 6px 0; color: #f8fafc; font-size: 15px; }
        .roulette-rules div { margin-bottom: 4px; }
...
<body>
    ...
    <div class="container">
        ...
        <div id="roulette-screen" class="game-screen">
            ...
            <!-- Правила рулетки красиво слева в ряд -->
            <div class="roulette-rules">
                <h4>Правила игры:</h4>
                <div>1. Ставка: 100, 250, 500</div>
                <div>2. Цвет (х1.5) или Число (х30)</div>
            </div>

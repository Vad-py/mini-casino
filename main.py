...
<body>
    ...
    <script>
            ...
            let animInterval = setInterval(() => {
                ...
                if (counter > 15) {
                    ...
                    .then(data => {
                        ...
                        document.getElementById('mines-balance').innerText = data.balance;
        ...
        function startMinesGame() {
            ...
            let globalBalance = parseFloat(document.getElementById('mines-balance').innerText);
            ...
            .then(data => {
                ...
                potentialWinEl.innerText = currentMinesBet.toFixed(2) + ' гривень';
        ...
        function clickMinesCell(index) {
            ...
            .then(data => {
                ...
                if (data.hit_mine) {
                    ...
                    let winAmount = currentMinesBet * currentMultiplier;
                    potentialWinEl.innerText = winAmount.toFixed(2) + ' гривень';
                    cashoutAmountEl.innerText = winAmount.toFixed(2);
        ...
        function cashOutMines(isAuto = false) {
            ...
            .then(data => {
                ...
                if (!isAuto) {
                    potentialWinEl.innerText = `Забрано: ${data.win.toFixed(2)} гривень`;
                }
            });
        }
...
# Серверная логика для игры "Мины"
mines_session = {
    "active": False,
    "bet": 0,
    "mines": 0,

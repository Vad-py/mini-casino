...
<head>
    ...
    <style>
        ...
        @keyframes spinBall {
            0% { transform: rotate(0deg) translate(168px) rotate(0deg); }
            100% { transform: rotate(1800deg) translate(168px) rotate(-1800deg); }
        }
...
<body>
    ...
    <script>
        ...
        window.onload = function() {
            ...
            const radius = 168; // Точно по центру ровного круга

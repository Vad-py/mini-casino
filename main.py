...
<body>
    ...
    <script>
        ...
        // --- WEB AUDIO API ДЛЯ ИДЕАЛЬНЫХ ЗВУКОВ РУЛЕТКИ ---
        let audioCtx = null;
        ...
        // Звук удара мячика/прохода лунки (маячок)
        ...
        // Звук выигрыша (двойной победный аккорд)
        ...
        // Звук проигрыша (нисходящий минорный тон)
        ...
        function spinRoulette() {
            ...
            .then(data => {
                ...
                // Синхронизированные звуковые щелчки под замедляющееся вращение
                ...
                setTimeout(() => {
                    ...
                    // Звук выигрыша или проигрыша в зависимости от результата
                    if (data.win > 0) {
                        playWinSound();
                    } else {
                        playLoseSound();

    ...
    <script>
        ...
        function playWinSound() {
            try {
                ...
                // Более широкая и триумфальная пачка нот с насыщенными гармониками
                let notes = [523.25, 659.25, 783.99, 1046.50, 1318.51, 1567.98];
                notes.forEach((freq, index) => {
                    let osc = ctx.createOscillator();
                    let gain = ctx.createGain();
                    
                    // Комбинация треугольной и синусоидальной волны для сочности
                ...
                if (counter > 15) {
                    ...
                    .then(data => {
                        ...
                        if (data.win > 0) {
                            ...
                            playWinSound(); // Звук мощного выигрыша в слотах
                        } else {
        ...
        function spinRoulette() {
            ...
            .then(data => {
                ...
                setTimeout(() => {
                    ...
                    if (data.win > 0) {
                        playWinSound(); // Звук мощного выигрыша в колесе
                    } else {
                        playLoseSound();
                    }
                }, 5000);
        ...
        function cashOutMines(isAuto = false) {
            ...
            .then(data => {
                ...
                playWinSound(); // Звук мощного выигрыша при нажатии «Забрать» в минах!
